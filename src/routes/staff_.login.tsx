...
export const Route = createFileRoute("/staff_/login")({
  ...
  head: () => ({ meta: [{ title: "Staff Login — MV THE CROWN" }] }),
});
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <img
            ...
            draggable={false}
          />
          <h1 className="font-display text-3xl text-background">MV THE CROWN</h1>
          <p className="eyebrow text-gold-soft text-[10px] mt-1 tracking-[0.22em] whitespace-nowrap">
            Staff Dashboard
          </p>
        </div>
        ...
        <p className="text-center text-xs text-background/40 mt-6">
          Staff access only · MV THE CROWN
        </p>
      </div>
    </div>
  );
