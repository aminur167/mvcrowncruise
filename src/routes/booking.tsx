...
export const Route = createFileRoute("/booking")({
  ...
  head: () => ({
    meta: [
      { title: "Book Your Voyage — MV THE CROWN" },
      {
        name: "description",
...
function StepPayment({
  ...
  const voyageTitle =
    selectedPackage?.marketing_title || `${selectedPackage?.ship.name ?? "MV THE CROWN"} Voyage`;
            ...
            <div className="relative bg-linear-to-br from-ocean via-ocean to-midnight px-5 py-4 overflow-hidden">
              ...
              <div className="relative">
                <div className="flex items-center gap-2 eyebrow text-gold-soft text-[9px]">
                  ...
                  {selectedPackage?.ship.name ?? "MV THE CROWN"}
                </div>
...
function ConfirmScreen({ booking, contactName }: { booking: BookingPublic; contactName: string }) {
  ...
  const waMessage = encodeURIComponent(
    `🚢 *MV THE CROWN — Booking Confirmed*\n\n` +
    ...
    win.document.write(`
      ...
      <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        <div class="header">
          <div class="brand"><h1>MV THE CROWN</h1><p>Cruise Ship</p></div>
        ...
        <div class="footer">
          ...
          <p>+880 1712-823482 &nbsp;|&nbsp; info@mvthecrown.com</p>
        </div>
      </body></html>
    `);
    win.document.close();
        ...
        >
          ...
          <div className="p-7 md:p-8 border-b border-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="font-display text-2xl tracking-widest">MV THE CROWN</div>
