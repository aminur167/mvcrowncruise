...
export const Route = createFileRoute("/cruise-experience")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pool deck, conference hall, BBQ deck, prayer room, lounges, Starlink internet — every facility on MV THE CROWN, plus a day-by-day expedition map." },
    ],
  }),
});
      ...
      <section className="grid md:grid-cols-2">
        ...
        <div className="bg-ocean text-background p-12 md:p-20 flex flex-col justify-center">
          ...
          <p className="mt-6 text-background/75 leading-relaxed">
            MV THE CROWN is engineered like a luxury hotel that happens to navigate. Three full decks, thirty-one suites, two restaurants, a pool, a conference suite, and a crew trained in five-star hospitality.
          </p>
        </div>
