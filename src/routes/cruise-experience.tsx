...
export const Route = createFileRoute("/cruise-experience")({
  ...
  head: () => ({
    meta: [
      { title: "Onboard Experience — MV THE CROWN" },
      {
        name: "description",
        content:
          "Pool deck, conference hall, BBQ deck, prayer room, lounges, Starlink internet — every facility on MV THE CROWN, plus a day-by-day expedition map.",
      },
    ],
  }),
});
...
const facilities = [
  {
    icon: Crown,
    name: "Private Balcony Cabins",
    desc: "River-facing glass doors and warm wood interiors.",
  },
  {
    icon: Eye,
    name: "Panorama View Rooms",
    desc: "Floor-to-ceiling windows, uninterrupted horizon.",
  },
  {
    icon: Sparkles,
    name: "Open Sky Pool Deck",
    desc: "Infinity-style plunge pool with sunset bar.",
  },
  {
    icon: Coffee,
    name: "Buffet Dining Hall",
    desc: "Climate-controlled fine dining with live stations.",
  },
  { icon: Anchor, name: "BBQ Deck", desc: "Live grill nights under string lights and stars." },
  {
    icon: Users,
    name: "Conference Hall",
    desc: "Full A/V suite for corporate retreats and events.",
  },
  ...
  {
    icon: Wind,
    name: "Wildlife Viewing Deck",
    desc: "Telescopes, naturalist briefings, photo blinds.",
  },
  {
    icon: Wifi,
    name: "Starlink Internet",
    desc: "High-speed satellite Wi-Fi across the entire ship.",
  },
  {
    icon: Shield,
    name: "Armed Forest Security",
    desc: "Trained forest guards on every expedition.",
  },
  {
    icon: Compass,
    name: "Naturalist Guides",
    desc: "Bangladesh's most experienced Sundarbans guides.",
  },
];
...
const journey: Stop[] = [
  {
    ...
    icon: "anchor",
    type: "anchor",
    desc: "The voyage begins at Khulna jetty. A champagne welcome on the sky deck and a ceremonial conch as MV THE CROWN eases away from the dock and turns south down the Rupsha river.",
    highlights: [
      "Champagne welcome on the sky deck",
      "Suite check-in with cold towel service",
      "Captain's safety brief",
      "First lunch service as we set sail",
    ],
  },
  {
    id: "rupsha",
    ...
    highlights: [
      "Naturalist briefing with maps",
      "Brahminy kite sightings",
      "High tea on the upper deck",
      "First mangrove silhouettes at dusk",
    ],
  },
  {
    id: "bbq",
    ...
    highlights: [
      "Open-air BBQ banquet",
      "River prawn & smoked hilsa",
      "Live acoustic set",
      "Stargazing from the lounge deck",
    ],
  },
  {
    id: "karamjal",
    ...
    highlights: [
      "Sunrise tender ride",
      "Crocodile breeding pools",
      "Spotted deer sanctuary",
      "Canopy boardwalk loop",
    ],
  },
  {
    id: "andharmanik",
    ...
    highlights: [
      "Small-craft canal expedition",
      "Kingfisher photo stop",
      "Macaque troop encounters",
      "Tidal-channel naturalist talk",
    ],
  },
  {
    id: "kotka",
    ...
    highlights: [
      "Tiger-tracking watchtower trek",
      "Open meadow safari",
      "Sundarbans interpretive walk",
  ...
  },
  {
    ...
    highlights: [
      "Farewell brunch service",
      "Printed voyage log",
      "Portrait keepsake",
      "Disembarkation at Khulna jetty",
    ],
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            The <em className="not-italic">ship</em>, in detail.
          </>
        }
      ...
      <section className="py-28 md:py-36 bg-background">
        <div className="container-luxe">
          <SectionHeader
            ...
            title={
              <>
                Everything you'd expect — <em className="not-italic">and more</em>.
              </>
            }
          />
      ...
      <section className="py-28 md:py-36 bg-background border-t border-border">
        <div className="container-luxe">
          <SectionHeader
            ...
            title={
              <>
                Three days. <em className="not-italic">A feast every stop.</em>
              </>
            }
      ...
      <section className="py-28 md:py-36 bg-secondary/30 border-y border-border">
        <div className="container-luxe">
          <SectionHeader
            ...
            title={
              <>
                Three days. Eight stops. <em className="not-italic">One cinematic arc.</em>
              </>
            }
            description="A guided walk through every moment aboard MV THE CROWN — from the champagne welcome at Khulna to the wild Bay of Bengal coastline at Jamtola. Tap any node on the map, hover for context, or share a single stop with a friend."
          />
          <div className="mt-16">
      ...
      <section className="grid md:grid-cols-2">
        ...
        <div className="bg-ocean text-background p-12 md:p-20 flex flex-col justify-center">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-light leading-tight">
            A floating five-star hotel — not a boat.
          </h2>
          <p className="mt-6 text-background/75 leading-relaxed">
            MV THE CROWN is engineered like a luxury hotel that happens to navigate. Three full
            decks, thirty-one suites, two restaurants, a pool, a conference suite, and a crew
            trained in five-star hospitality.
          </p>
        </div>
        <div className="bg-mangrove text-background p-12 md:p-20 flex flex-col justify-center md:order-3">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-light leading-tight">
            Forty hands. One mission.
          </h2>
          <p className="mt-6 text-background/75 leading-relaxed">
            From the master chef to the naturalists to the housekeeping team — every crew member is
            hand-picked, trained, and committed to making your voyage unforgettable.
          </p>
        </div>
